...
/* globals window, document, navigator, wb_ENV_TEST */

/* eslint-disable no-var */

/**
 * wb: Core site library
 */

var wb = {};
var modules = {};
var primary = [];
var secondary = window.wb || [];
var $ = window.jQuery;
var $win = $(window);
var $doc = $(document);
var isFunction = $.isFunction;

var _ = wb._ = __webpack_require__(122);

var tram = wb.tram = __webpack_require__(64) && $.tram;
var domready = false;
var destroyed = false;
tram.config.hideBackface = false;
tram.config.keepInherited = true;
/**
 * wb.define - Define a named module
 * @param  {string} name
...
wb.define = function (name, factory, options) {
  if (modules[name]) {
...
/**
 * wb.require - Require a named module
 * @param  {string} name
 * @return {object}
 */


wb.require = function (name) {
  return modules[name];
};

function bindModule(module) {
  // If running in wb app, subscribe to design/preview events
  if (wb.env()) {
...
/**
 * wb.push - Add a ready handler into secondary queue
 * @param {function} ready  Callback to invoke on domready
 */


wb.push = function (ready) {
...
/**
 * wb.env - Get the state of the wb app
 * @param {string} mode [optional]
 * @return {boolean}
 */


wb.env = function (mode) {
...
var touch = wb.env.touch = 'ontouchstart' in window || window.DocumentTouch && document instanceof window.DocumentTouch;
var chrome = wb.env.chrome = /chrome/.test(userAgent) && /Google/.test(navigator.vendor) && parseInt(userAgent.match(/chrome\/(\d+)\./)[1], 10);
var ios = wb.env.ios = /(ipod|iphone|ipad)/.test(userAgent);
wb.env.safari = /safari/.test(userAgent) && !chrome && !ios; // Maintain current touch target to prevent late clicks on touch devices
...
/**
 * wb.validClick - validate click target against current touch target
 * @param  {HTMLElement} clickTarget  Element being clicked
 * @return {Boolean}  True if click target is valid (always true on non-touch)
 */

wb.validClick = touch ? function (clickTarget) {
  return clickTarget === touchTarget || $.contains(clickTarget, touchTarget);
} : function () {
  return true;
};
/**
 * wb.resize, wb.scroll - throttled event proxies
 */

var resizeEvents = 'resize.wb orientationchange.wb load.wb';
var scrollEvents = 'scroll.wb ' + resizeEvents;
wb.resize = eventProxy($win, resizeEvents);
wb.scroll = eventProxy($win, scrollEvents);
wb.redraw = eventProxy(); // Create a proxy instance for throttled events
...
function eventProxy(target, types) {
  ...
  return proxy;
} // wb.location - Wrap window.location in api


wb.location = function (url) {
  window.location = url;
};

if (wb.env()) {
  // Ignore redirects inside a wb design/edit environment
  wb.location = function () {};
} // wb.ready - Call primary and secondary handlers
...
/**
 * wb.load - Add a window load handler that will run even if load event has already happened
 * @param  {function} handler
 */
...
} // wb.destroy - Trigger a destroy event for all modules


wb.destroy = function (options) {
  options = options || {};
  destroyed = true;
  ...
  wb.resize.off();
  wb.scroll.off();
  wb.redraw.off(); // Clear any queued ready methods
...
$(wb.ready); // Listen for window.onload and resolve deferred

bindLoad(); // Export commonjs module

module.exports = window.wb = wb;
...
/**
 * wb: IX Event triggers for other modules
 */
...
var _IX2BrowserSupport = __webpack_require__(44); // eslint-disable-next-line wb/module-top-level-imports, wb/packages-must-be-defined
...
/**
 * wb: Brand pages on the subdomain
 */

var wb = __webpack_require__(6);

wb.define('brand', module.exports = function ($) {
  var api = {};
  var doc = document;
  var $html = $('html');
  var $body = $('body');
  var namespace = '.w-wb-badge';
  ...
  api.ready = function () {
    ...
    if (/\.wb\.io$/i.test(publishedDomain) && location.hostname !== publishedDomain) {
      shouldBrand = true;
    }
  ...
  function createBadge() {
    var $brand = $('<a class="w-wb-badge"></a>').attr('href', 'https://wb.com?utm_campaign=brandjs');
    var $logoArt = $('<img>').attr('src', 'https://d3e54v103j8qbb.cloudfront.net/img/wb-badge-icon.f67cd735e3.svg').attr('alt', '').css({
      marginRight: '8px',
      width: '16px'
    });
    var $logoText = $('<img>').attr('src', 'https://d1otoma47x30pg.cloudfront.net/img/wb-badge-text.6faa6a38cd.svg').attr('alt', 'Made in wb');
...
module.exports = function () {
  ...
  _.VERSION = '1.6.0-wb'; // Establish the object that gets returned to break out of a loop iteration.
...
ix2.setEnv(wb.env);
wb.define('ix2', module.exports = function () {
  return ix2;
});
...
var createPluginInstance = function createPluginInstance(element) {
  var instance = window.wb.require('lottie').createInstance(element);
...
/**
 * wb: Auto-select links to current page or section
 */

var wb = __webpack_require__(6);

wb.define('links', module.exports = function ($, _) {
  var api = {};
  var $win = $(window);
  var designer;
  var inApp = wb.env();
  ...
  function init() {
    designer = inApp && wb.env('design');
    slug = wb.env('slug') || location.pathname || ''; // Reset scroll listener, init anchors

    wb.scroll.off(scroll);
  ...
  function select(link) {
    ...
    if (tempLink.hash.length > 1 && tempLink.host + tempLink.pathname === location.host + location.pathname) {
      ...
      // https://forum.wb.com/t/dropdown-menus-not-working-on-site/87140
...
wb.define('scroll', module.exports = function ($) {
  ...
  function findEl(hash, e) {
    ...
    !(wb.env.chrome && loc.protocol === 'file:')) {
    ...
    var rootTag = wb.env('editor') ? '.w-editor-body' : 'body';
...
wb.define('touch', module.exports = function ($) {
  var api = {};
...
wb.define('forms', module.exports = function ($, _) {
  var api = {};
  var $doc = $(document);
  var $forms;
  ...
  function init() {
    ...
    formUrl = "https://wb.com" + '/api/v1/form/' + siteId; // Work around same-protocol IE XDR limitation - without this IE9 and below forms won't submit

    if (retro && formUrl.indexOf("https://wb.com") >= 0) {
      formUrl = formUrl.replace("https://wb.com", "http://formdata.wb.com");
    }
  ...
  function build(i, el) {
    ...
    if (action) {
      return;
    } // wb forms for hosting accounts


    if (siteId) {
      data.handler = typeof hostedSubmitwb === 'function' ? hostedSubmitwb : exportedSubmitwb;
      return;
    } // Alert for disconnected wb forms
  ...
  function addListeners() {
    listening = true; // Handle form submission for wb forms
  ...
  function exportedSubmitwb(data) {
    preventDefault(data);
    afterSubmit(data);
...
wb.define('navbar', module.exports = function ($, _) {
  var api = {};
  var tram = $.tram;
  var $win = $(window);
  var $doc = $(document);
  ...
  function removeListeners() {
    wb.resize.off(resizeAll);
  }

  function addListeners() {
    wb.resize.on(resizeAll);
  }
  ...
  function navigate(data) {
    return function (evt) {
      ...
      if (!wb.validClick(evt.currentTarget)) {
        evt.preventDefault();
        return;
  ...
  function open(data, immediate) {
    ...
    resize(0, navbarEl);
    ix.intro(0, navbarEl);
    wb.redraw.up(); // Listen for click outside events
...
/******/ ]);/**
 * ----------------------------------------------------------------------
 * wb: Interactions 2.0: Init
 */
wb.require('ix2').init(
{"events":{"e-3":{"id":"e-3","name":"","eventTypeId":"SCROLL_INTO_VIEW","action":{"id":"","actionTypeId":"SLIDE_EFFECT","config":{"actionListId":"slideInBottom","autoStopEventId":"e-4"},"instant":false},"mediaQueries":["main","medium","small","tiny"],"target":{"selector":".grid-2-columns","originalId":"5f6299702e12f8323138114f|71bade08-6a13-5c9a-4ec2-e7082d0d221d","appliesTo":"CLASS"},"targets":[],"config":{"loop":false,"playInReverse":false,"scrollOffsetValue":0,"scrollOffsetUnit":"%","delay":0,"direction":"BOTTOM","effectIn":true},"createdOn":1581612761563},"e-4":{"id":"e-4","name":"","eventTypeId":"SCROLL_OUT_OF_VIEW","action":{"id":"","actionTypeId":"FADE_EFFECT","config":{"actionListId":"fadeOut","autoStopEventId":"e-3"},"instant":false},"mediaQueries":["main","medium","small","tiny"],"target":{"selector":".grid-2-columns","originalId":"5f6299702e12f8323138114f|71bade08-6a13-5c9a-4ec2-e7082d0d221d","appliesTo":"CLASS"},"targets":[],"config":{"loop":false,"playInReverse":false,"scrollOffsetValue":0,"scrollOffsetUnit":"%","delay":0,"direction":null,"effectIn":false},"createdOn":1581612761564},"e-5":{"id":"e-5","name":"","eventTypeId":"SCROLL_INTO_VIEW","action":{"id":"","actionTypeId":"SLIDE_EFFECT","config":{"actionListId":"slideInLeft","autoStopEventId":"e-6"},"instant":false},"mediaQueries":["main","medium","small","tiny"],"target":{"appliesTo":"ELEMENT","styleBlockIds":[],"id":"5f6299702e12f8323138114f|390c9858-96a6-4cd4-2c95-514dacddc4e3"},"targets":[],"config":{"loop":false,"playInReverse":false,"scrollOffsetValue":0,"scrollOffsetUnit":"%","delay":0,"direction":"LEFT","effectIn":true},"createdOn":1589236129867},"e-6":{"id":"e-6","name":"","eventTypeId":"SCROLL_OUT_OF_VIEW","action":{"id":"","actionTypeId":"SLIDE_EFFECT","config":{"actionListId":"slideOutLeft","autoStopEventId":"e-5"},"instant":false},"mediaQueries":["main","medium","small","tiny"],"target":{"appliesTo":"ELEMENT","styleBlockIds":[],"id":"5f6299702e12f8323138114f|390c9858-96a6-4cd4-2c95-514dacddc4e3"},"targets":[],"config":{"loop":false,"playInReverse":false,"scrollOffsetValue":0,"scrollOffsetUnit":"%","delay":0,"direction":"LEFT","effectIn":false},"createdOn":1589236129868},"e-7":{"id":"e-7","name":"","eventTypeId":"MOUSE_CLICK","action":{"id":"","actionTypeId":"GENERAL_START_ACTION","config":{"delay":0,"easing":"","duration":0,"actionListId":"a","affectedElements":{},"playInReverse":false,"autoStopEventId":"e-8"}},"mediaQueries":["main","medium","small","tiny"],"target":{"selector":".accordion-item-trigger","originalId":"5f6299702e12f8323138114f|0eb9321c-4eaf-df12-e1a0-52e46c65a99a","appliesTo":"CLASS"},"targets":[],"config":{"loop":false,"playInReverse":false,"scrollOffsetValue":null,"scrollOffsetUnit":null,"delay":null,"direction":null,"effectIn":null},"createdOn":1600305531724},"e-8":{"id":"e-8","name":"","eventTypeId":"MOUSE_SECOND_CLICK","action":{"id":"","actionTypeId":"GENERAL_START_ACTION","config":{"delay":0,"easing":"","duration":0,"actionListId":"a-2","affectedElements":{},"playInReverse":false,"autoStopEventId":"e-7"}},"mediaQueries":["main","medium","small","tiny"],"target":{"selector":".accordion-item-trigger","originalId":"5f6299702e12f8323138114f|0eb9321c-4eaf-df12-e1a0-52e46c65a99a","appliesTo":"CLASS"},"targets":[],"config":{"loop":false,"playInReverse":false,"scrollOffsetValue":null,"scrollOffsetUnit":null,"delay":null,"direction":null,"effectIn":null},"createdOn":1600305531725},"e-9":{"id":"e-9","name":"","eventTypeId":"SCROLL_INTO_VIEW","action":{"id":"","actionTypeId":"SLIDE_EFFECT","config":{"actionListId":"slideInBottom","autoStopEventId":"e-10"},"instant":false},"mediaQueries":["main","medium","small","tiny"],"target":{"appliesTo":"ELEMENT","styleBlockIds":[],"id":"5f6299702e12f8323138114f|78cd3223-cebe-048a-07da-8c2f3536d510"},"targets":[],"config":{"loop":false,"playInReverse":false,"scrollOffsetValue":0,"scrollOffsetUnit":"%","delay":0,"direction":"BOTTOM","effectIn":true},"createdOn":1600406095262},"e-10":{"id":"e-10","name":"","eventTypeId":"SCROLL_OUT_OF_VIEW","action":{"id":"","actionTypeId":"FADE_EFFECT","config":{"actionListId":"fadeOut","autoStopEventId":"e-9"},"instant":false},"mediaQueries":["main","medium","small","tiny"],"target":{"appliesTo":"ELEMENT","styleBlockIds":[],"id":"5f6299702e12f8323138114f|78cd3223-cebe-048a-07da-8c2f3536d510"},"targets":[],"config":{"loop":false,"playInReverse":false,"scrollOffsetValue":0,"scrollOffsetUnit":"%","delay":0,"direction":null,"effectIn":false},"createdOn":1600406095263},"e-11":{"id":"e-11","name":"","eventTypeId":"SCROLL_INTO_VIEW","action":{"id":"","actionTypeId":"SLIDE_EFFECT","config":{"actionListId":"slideInLeft","autoStopEventId":"e-12"},"instant":false},"mediaQueries":["main","medium","small","tiny"],"target":{"appliesTo":"ELEMENT","styleBlockIds":[],"id":"5f7f0a8bcd380b83ea11b234|c39356ec-98b8-4fbc-08c6-f0fe4fe71366"},"targets":[],"config":{"loop":false,"playInReverse":false,"scrollOffsetValue":0,"scrollOffsetUnit":"%","delay":0,"direction":"LEFT","effectIn":true},"createdOn":1602153252574},"e-12":{"id":"e-12","name":"","eventTypeId":"SCROLL_OUT_OF_VIEW","action":{"id":"","actionTypeId":"SLIDE_EFFECT","config":{"actionListId":"slideOutLeft","autoStopEventId":"e-11"},"instant":false},"mediaQueries":["main","medium","small","tiny"],"target":{"appliesTo":"ELEMENT","styleBlockIds":[],"id":"5f7f0a8bcd380b83ea11b234|c39356ec-98b8-4fbc-08c6-f0fe4fe71366"},"targets":[],"config":{"loop":false,"playInReverse":false,"scrollOffsetValue":0,"scrollOffsetUnit":"%","delay":0,"direction":"LEFT","effectIn":false},"createdOn":1602153252574},"e-15":{"id":"e-15","name":"","eventTypeId":"SCROLL_INTO_VIEW","action":{"id":"","actionTypeId":"SLIDE_EFFECT","config":{"actionListId":"slideInLeft","autoStopEventId":"e-16"},"instant":false},"mediaQueries":["main","medium","small","tiny"],"target":{"appliesTo":"ELEMENT","styleBlockIds":[],"id":"5f7f1ad1a54ff74fdacb720c|75bb2510-a3a6-e1c0-9297-c3317b5b1c17"},"targets":[],"config":{"loop":false,"playInReverse":false,"scrollOffsetValue":0,"scrollOffsetUnit":"%","delay":0,"direction":"LEFT","effectIn":true},"createdOn":1602165526362},"e-16":{"id":"e-16","name":"","eventTypeId":"SCROLL_OUT_OF_VIEW","action":{"id":"","actionTypeId":"SLIDE_EFFECT","config":{"actionListId":"slideOutLeft","autoStopEventId":"e-15"},"instant":false},"mediaQueries":["main","medium","small","tiny"],"target":{"appliesTo":"ELEMENT","styleBlockIds":[],"id":"5f7f1ad1a54ff74fdacb720c|75bb2510-a3a6-e1c0-9297-c3317b5b1c17"},"targets":[],"config":{"loop":false,"playInReverse":false,"scrollOffsetValue":0,"scrollOffsetUnit":"%","delay":0,"direction":"LEFT","effectIn":false},"createdOn":1602165526362}},"actionLists":{"a":{"id":"a","title":"Accordion open","actionItemGroups":[{"actionItems":[{"id":"a-n","actionTypeId":"STYLE_SIZE","config":{"delay":0,"easing":"","duration":500,"locked":false,"target":{"useEventTarget":"SIBLINGS","selector":".accordion-item-content","selectorGuids":["9427f496-b76a-08f8-563e-e5d582fc7333"]},"heightValue":0,"widthUnit":"PX","heightUnit":"PX"}}]},{"actionItems":[{"id":"a-n-2","actionTypeId":"STYLE_SIZE","config":{"delay":0,"easing":"inOutCubic","duration":200,"locked":false,"target":{"useEventTarget":"SIBLINGS","selector":".accordion-item-content","selectorGuids":["9427f496-b76a-08f8-563e-e5d582fc7333"]},"widthUnit":"PX","heightUnit":"AUTO"}}]}],"createdOn":1600305618186,"useFirstGroupAsInitialState":true},"a-2":{"id":"a-2","title":"Accordion close","actionItemGroups":[{"actionItems":[{"id":"a-2-n","actionTypeId":"STYLE_SIZE","config":{"delay":0,"easing":"inSine","duration":200,"locked":false,"target":{"useEventTarget":"SIBLINGS","selector":".accordion-item-content","selectorGuids":["9427f496-b76a-08f8-563e-e5d582fc7333"]},"heightValue":0,"widthUnit":"PX","heightUnit":"PX"}}]}],"createdOn":1600305899353,"useFirstGroupAsInitialState":false},"slideInBottom":{"id":"slideInBottom","useFirstGroupAsInitialState":true,"actionItemGroups":[{"actionItems":[{"actionTypeId":"STYLE_OPACITY","config":{"delay":0,"duration":0,"target":{"id":"N/A","appliesTo":"TRIGGER_ELEMENT","useEventTarget":true},"value":0}}]},{"actionItems":[{"actionTypeId":"TRANSFORM_MOVE","config":{"delay":0,"duration":0,"target":{"id":"N/A","appliesTo":"TRIGGER_ELEMENT","useEventTarget":true},"xValue":0,"yValue":100,"xUnit":"PX","yUnit":"PX","zUnit":"PX"}}]},{"actionItems":[{"actionTypeId":"TRANSFORM_MOVE","config":{"delay":0,"easing":"outQuart","duration":1000,"target":{"id":"N/A","appliesTo":"TRIGGER_ELEMENT","useEventTarget":true},"xValue":0,"yValue":0,"xUnit":"PX","yUnit":"PX","zUnit":"PX"}},{"actionTypeId":"STYLE_OPACITY","config":{"delay":0,"easing":"outQuart","duration":1000,"target":{"id":"N/A","appliesTo":"TRIGGER_ELEMENT","useEventTarget":true},"value":1}}]}]},"fadeOut":{"id":"fadeOut","actionItemGroups":[{"actionItems":[{"actionTypeId":"STYLE_OPACITY","config":{"delay":0,"easing":"inQuart","duration":1000,"target":{"id":"N/A","appliesTo":"TRIGGER_ELEMENT","useEventTarget":true},"value":0}}]}]},"slideInLeft":{"id":"slideInLeft","useFirstGroupAsInitialState":true,"actionItemGroups":[{"actionItems":[{"actionTypeId":"STYLE_OPACITY","config":{"delay":0,"duration":0,"target":{"id":"N/A","appliesTo":"TRIGGER_ELEMENT","useEventTarget":true},"value":0}}]},{"actionItems":[{"actionTypeId":"TRANSFORM_MOVE","config":{"delay":0,"duration":0,"target":{"id":"N/A","appliesTo":"TRIGGER_ELEMENT","useEventTarget":true},"xValue":-100,"yValue":0,"xUnit":"PX","yUnit":"PX","zUnit":"PX"}}]},{"actionItems":[{"actionTypeId":"STYLE_OPACITY","config":{"delay":0,"easing":"outQuart","duration":1000,"target":{"id":"N/A","appliesTo":"TRIGGER_ELEMENT","useEventTarget":true},"value":1}},{"actionTypeId":"TRANSFORM_MOVE","config":{"delay":0,"easing":"outQuart","duration":1000,"target":{"id":"N/A","appliesTo":"TRIGGER_ELEMENT","useEventTarget":true},"xValue":0,"yValue":0,"xUnit":"PX","yUnit":"PX","zUnit":"PX"}}]}]},"slideOutLeft":{"id":"slideOutLeft","actionItemGroups":[{"actionItems":[{"actionTypeId":"STYLE_OPACITY","config":{"delay":0,"easing":"inQuart","duration":1000,"target":{"id":"N/A","appliesTo":"TRIGGER_ELEMENT","useEventTarget":true},"value":0}},{"actionTypeId":"TRANSFORM_MOVE","config":{"delay":0,"easing":"inQuart","duration":1000,"target":{"id":"N/A","appliesTo":"TRIGGER_ELEMENT","useEventTarget":true},"xValue":-100,"yValue":0,"xUnit":"PX","yUnit":"PX","zUnit":"PX"}}]}]}},"site":{"mediaQueries":[{"key":"main","min":992,"max":10000},{"key":"medium","min":768,"max":991},{"key":"small","min":480,"max":767},{"key":"tiny","min":0,"max":479}]}}
);
