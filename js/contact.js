...
firebase.analytics();
  ...
  var messagesRef = firebase.database().ref('Contact Form Responses');
  ...
  function submitForm(e){
    ...
    // Save message
    saveMessage(firstname, lastname, email, phone, university, message);
  ...
  function saveMessage(firstname, lastname, email, phone, university, message){
